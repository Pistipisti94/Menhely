...
<div class="container">
    <form action="#" method="post">
        ...
        <div class="row">
        <button type="submit" class="col-3 mx-auto btn btn-primary" name="belepesiAdatok" value="true">Belépés</button>
        </div>
    </form>
    <div class="row">
    <button class="col-3 mx-auto my-2 btn btn-primary"><a href="index.php?menu=regisztracio">Regisztráció</a></button>
    </div>
</div>